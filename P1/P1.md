...
-  **gotoxy(): colocar le cursos en una posición determinada** (#gotoxy)
...
- **setcursortype(): fijar el aspecto del cursor** (#cursor)
...
- **setvideomode(): fijar el modo de vídeo** (#setvideo)
...
- **getvideomode(): obtener el modo de vídeo** (#getvideo)
...
- **textcolor() y textbackground(): modificar el color de primer plano y el fondo** (#textfondo)
...
- **clrscr(): borrar toda la pantalla** (#clrscr)
...
- **cputchar(): escribir un carácter en pantalla** (#cputchar)
...
- **getche(): obtener un carácter de teclado (y mostrarlo)** (#getche)
